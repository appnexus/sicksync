...
module.exports = {
    ...
    wakeDevBox: function(host, fn) {
        ...
        // TODO: this is super hacky, we need a way to know once the server is up and accepting connections
        sicksyncServer.on('exit', function() {
            console.log('[wakeDevBox] the server has exited');
            setTimeout(fn, 5000);
        });
    },
